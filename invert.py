...
METHOD = "adaconv"
G_PATH = f"pretrained/8-vectors-001600.pkl" # pretrained/alpha-{METHOD}-003200.pkl"
OUT_DIR = f"out/{METHOD}-cat"

NUM_STEPS = 500
SEQUENTIAL = False
# VARIABLE_TYPE = ZVariableInitAtMean if METHOD == "adaconv" else WPlusVariableInitAtMean
VARIABLE_TYPE = WVariableInitAtMean
...
TARGET_A_PATH = "./datasets/samples/cats/00000/img00000013.png"
# f"/home-local2/yopog.extra.nobkp/stylegan2-ada-pytorch/datasets/samples/churches/a.webp" # ./datasets/samples/cats/00000/img00000013.png
TARGET_B_PATH = "./datasets/samples/cats/00000/img00000003.png"
